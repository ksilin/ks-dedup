...
public class AvroDeduplicationDLQProcessorTest {
    ...
    private final String successProcessorName = "success-child";
    private final String dlqProcessorName = "error-child";
    ...
    public void setup() {
        ...
        dlqTopic = testDriver.createOutputTopic(DLQ_TOPIC, stringSerde.deserializer(), avroSerde.deserializer());
    }
    ...
    public Topology createTestTopology() {
        ...
        KStream<String, GenericRecord> processedValues = builder.<String, GenericRecord>stream(INPUT_TOPIC, Consumed.with(Serdes.String(), avroSerde))
                .processValues(() -> new AvroDeduplicationDLQProcessor(storeName, successProcessorName, dlqProcessorName),
                               storeName
                );
        processedValues
                .to(OUTPUT_TOPIC, Produced.with(Serdes.String(), avroSerde).withName(successProcessorName));
        processedValues.to(DLQ_TOPIC, Produced.with(Serdes.String(), avroSerde).withName(dlqProcessorName));
    ...
    public void testDeduplicationOfDuplicates() {
        ...
        List<KeyValue<String, GenericRecord>> errors = dlqTopic.readKeyValuesToList();
